...
export const KaTeX = () => {
  ...
  return {
    ...
    init: function (reveal) {
      ...
      let cssUrl = baseUrl + versionString + "/external/katex.min.css";
      let katexUrl = baseUrl + versionString + "/external/katex.min.js";
      let mhchemUrl =
        baseUrl + versionString + "/external/contrib/mhchem.min.js";
      let karUrl =
        baseUrl + versionString + "/external/contrib/auto-render.min.js";
